      ...
      <div class="row photos">
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery01.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery02.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>

          </div>
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery03.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>

          </div>
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery04.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>

          </div>
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery05.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>

          </div>
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery06.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>

          </div>
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery07.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>

          </div>
          <div class="col-sm-6 col-md-4 col-lg-4 item">
            <a href="assets/img/desk.jpg" data-lightbox="photos">
              <img class="img-fluid" src="/images/gallery08.jpg"></a>
              <h6 class="fonth6">Lorem ipsum dolor sit amet consectetur adipisicing elit</h6>
